 ...
 *
 * and, when the model has a service-level wind case Wa (a shorter recurrence, whose speed the
 * commentary's Figura C AB.4.2-1 converts from the 50-year one):
 *
 *   D + Wa · D + 0,5 L + Wa
 *
 * The gravity-only ones are the characteristic combination, every action at 1,0, and say so
 * rather than cite a clause:
 *
...
const R102_B42 = clause('cirsoc-102', '2025', 'B.4.2', 'servicio');
