...
fn validation_corotational_cantilever_end_moment() {
    ...
    let corot = corot_res.expect("end-moment corotational solve must succeed");
...
fn validation_corotational_portal_pdelta() {
    ...
    let corot = corot_res.expect("portal P-delta corotational solve must succeed");
...
fn validation_corotational_equilibrium_preservation() {
    ...
    let corot = corot_res.expect("equilibrium-preservation corotational solve must succeed");
...
fn validation_corotational_symmetry() {
    ...
    let corot = corot_res.expect("symmetry corotational solve must succeed");
